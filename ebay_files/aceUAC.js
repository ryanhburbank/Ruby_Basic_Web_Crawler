...
var ACE3OP = navigator.appName == "Opera";
...
function ACE3_AdRequest(obj) {
 ...
 var se = -1;
 try {
  se = location.protocol == "https:" ? 1 : -1;
 } catch (e) {}
 ...
 var kvismob = typeof window.onorientationchange != "undefined" ? "1" : "2";
 if (/mobile|android|iphone|ipad|playbook|hp-tablet|kindle|silk|webos|blackberry|opera mini/i.test(navigator.appVersion)) {
  kvismob = "1";
 }
 s += "/kvismob=" + kvismob;
